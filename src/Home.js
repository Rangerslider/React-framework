...
onekta ek page thewke onno page e jite gele button click kore jaite hoi oiroko   */
...
//07.UseEffect hooks  dependencies:
...
//     const[name,setName] =useState('ishmoth');
...
//         console.log('ishmoth ura nuri');
//         console.log(name);
//     },[name]); //[name] is the dependencies

//     return ( 
//         <div className="home">
//         <BlogList blogs ={blogs} title="nuri's blog!" handleDelete = {handleDelete} />
//         <button onClick ={()  => setName('joy')}>Change name</button>
//         <p>{name}</p>
//         </div>
...
//                     setBlogs(data);   // data fetch kortese
//                 })
//     },[]);

//     return ( 
//         <div className="home">
//         {blogs && <BlogList blogs ={blogs} title="nuri's blog!" handleDelete = {handleDelete} />}
//         </div>
